param(
    ...
    [ValidateSet("env-json", "setup", "runtimes", "wsl", "prepare-wsl", "wsl-rootfs-guide", "wsl-import-plan", "wsl-import", "wsl-workflow", "install-runtime", "init-env", "service-env", "adapters", "sources", "probe-sources", "checkout-source", "setup-adapter", "verify-adapter", "mark-adapter-ready", "logs", "backup", "start", "start-adapter", "status", "stop")]
    [string]$Action = "setup",

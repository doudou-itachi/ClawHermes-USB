...
import { appendFileSync, closeSync, copyFileSync, existsSync, mkdirSync, openSync, readFileSync, rmSync, statSync, writeFileSync } from "node:fs";
import { dirname, join, sep } from "node:path";
import { get } from "node:http";
import type { AdapterDescriptor, EnvFileDiagnostic, EnvInitResult, PathDiagnostic, PortDiagnostic, ServiceEnvironment, ServiceEnvironmentDiagnostic, ServiceEnvFileResult, ServiceStatus } from "./types";

...
function wslPreparationCommand(distro) {
...
function isTcpPortAvailableSync(port) {
    ...
    try {
        ...
        const output = (0, node_child_process_1.execFileSync)(process.execPath, ["-e", script, String(port)], { encoding: "utf8", timeout: 3000, windowsHide: true }).trim();

...
- Should the first runnable version include a portable browser profile or rely on the host browser?
- Should backups include runtimes and apps, or only config/data?
- Should the portal be a static page served by a tiny Node server, or part of the core orchestrator?

...
- OpenClaw source-checkout startup is `node openclaw.mjs gateway --port 18789 --verbose --allow-unconfigured` after setup verifies Node.js 24 and pnpm 10.33.2.
...
- Should a future release add automatic port remapping when `8642`, `8648`, `18789`, or `17000` are occupied?
